...
function NewApiSection(props) {
  ...
  const [proxyUrl, setProxyUrl] = (0, import_react.useState)(PROXY_PRESETS[0]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "newapi-catalog", "aria-label": t("models"), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-proxyrow", children: [
        ...
        proxyEnabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "select",
            {
              className: "newapi-select",
              "aria-label": t("proxyPreset"),
              value: PROXY_PRESETS.includes(proxyUrl) ? proxyUrl : "custom",
              onChange: (event) => {
                if (event.target.value !== "custom") setProxyUrl(event.target.value);
              },
              children: [
                PROXY_PRESETS.map((preset) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: preset, children: preset }, preset)),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "custom", children: t("proxyCustom") })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    params === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-params", children: [
      ...
      params.models.map((entry) => {
        ...
        if (entry.matches.length === 1) {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-params-row", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-params-id", children: entry.id }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-params-values", children: `${match2.provider} \xB7 ${t("contextWindow")} ${match2.contextWindow ?? "\u2014"} / ${t("maxTokens")} ${match2.maxTokens ?? "\u2014"}` }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {})
          ] }, entry.id);
        }
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-params-row", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
            {
              ...
              children: entry.matches.map((candidate, at) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: String(at), children: `${candidate.provider}: ${t("contextWindow")} ${candidate.contextWindow ?? "\u2014"} / ${t("maxTokens")} ${candidate.maxTokens ?? "\u2014"}` }, candidate.provider))
            }
          ),
...
var en = {
  ...
  fetchCancel: "Cancel",
  updateParams: "Update model info",
