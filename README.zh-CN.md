...
| `0.1.5-rc.1` | **`0.8.6-rc.2`** | **计划发布，仍为 RC**；当前源码的隔离测试通过，完整安装与 Web 验证待完成 |

`0.8.6-rc.1` 会拒绝旧的 `0.1.1` 宿主。`0.1.5-rc.1` 的测试结果不代表已有插件包完成了该版本的发布验证，详见[适配评估](docs/2026-09-10-dsh-0.1.5-rc.1-assessment.md)。
