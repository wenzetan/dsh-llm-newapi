...
| `0.1.5-rc.1` | **`0.8.6-rc.2`** | **本地已验证，尚未发布**；类型检查、测试、构建与包内容检查通过，真实宿主 Web 验证待完成 |

`0.8.6-rc.2` 只针对 `0.1.5-rc.1` 宿主线，并会明确拒绝旧的 `0.1.2-rc.1` 宿主并提示升级；`0.1.2-rc.1` 用户继续使用插件 `0.8.6-rc.1`。详见[适配评估](docs/2026-09-10-dsh-0.1.5-rc.1-assessment.md)。
