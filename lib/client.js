...
var inputStyle = {
  ...
  background: "var(--dsw-alias-input-bg, #1b1b1b)",
  color: "inherit",
  fontSize: 13
};
var buttonStyle = {
...
function NewApiSection(props) {
  ...
  if (status === "error") {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": t("nav"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "#f87171" }, children: `${t("loadFailed")}: ${errorText ?? ""}` }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    errorText === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "#f87171" }, children: errorText }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: fieldStyle, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...fieldStyle, flexDirection: "row", alignItems: "center", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: t("models") }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: buttonStyle, disabled: busy, onClick: () => {
        void fetchModels();
    ...
    candidates === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { border: "1px solid var(--dsw-alias-border, #444)", borderRadius: 8, padding: 12, marginBottom: 12 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: t("fetchTitle") }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { style: { listStyle: "none", padding: 0, margin: "8px 0" }, children: candidates.map((model) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: primaryButtonStyle, disabled: picked.size === 0, onClick: adopt, children: t("fetchAdopt") }),
      " ",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: buttonStyle, onClick: () => {
        setCandidates(void 0);
        setPicked(/* @__PURE__ */ new Set());
    ...
    models.map((model, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: rowStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { fontSize: 12 }, children: t("modelHint") }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: primaryButtonStyle, disabled: busy || !writable, onClick: () => {
      void save();
