...
// src/index.ts
var MINIMUM_DSH_VERSION = "0.1.2-rc.1";
...
if (!isSupportedHostVersion(hostLlmVersion)) {
  throw new Error(
    `dsh-llm-newapi requires dsh >= ${MINIMUM_DSH_VERSION} (host ships @deepseek-ai/dsh-llm ${hostLlmVersion}); upgrade the host: npm install -g @deepseek-ai/dsh@next`
  );
}
